...
public class BungaAdapter extends RecyclerView.Adapter<BungaAdapter.MainViewHolder> implements Filterable {
    ...
    public BungaAdapter(Context context, List<ModelMain> modelMain) {
