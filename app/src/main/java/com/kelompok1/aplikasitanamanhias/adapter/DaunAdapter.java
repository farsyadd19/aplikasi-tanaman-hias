...
public class DaunAdapter extends RecyclerView.Adapter<DaunAdapter.MainViewHolder> implements Filterable {
    ...
    public DaunAdapter(Context context, List<ModelMain> modelMain) {
