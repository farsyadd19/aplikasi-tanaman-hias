...
public class KategoriBuah extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rvListBuah = findViewById(R.id.rvListBuah);
    ...
    private void getNamaTanaman() {
        try {
            InputStream stream = getAssets().open("tanaman_hiasbuah.json");
            ...
            try {
                ...
                buahAdapter = new BuahAdapter(this, modelMain);
                rvListBuah.setAdapter(buahAdapter);
            } catch (JSONException e) {
                e.printStackTrace();
            }
        } catch (IOException ignored) {
            Toast.makeText(KategoriBuah.this, "Ups, ada yang tidak beres. " +
