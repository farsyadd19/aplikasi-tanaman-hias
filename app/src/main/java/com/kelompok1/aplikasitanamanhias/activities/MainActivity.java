...
//    private void ShowAllTanaman() {
//        tanamanList = new ArrayList<>();
//        tanamanList = realm.where(tanaman_hias.class).findAll();
//        Log.d("TAG", "ShowAllCourse: "+tanamanList);
//        tanamanAdapter = new AllTanamanHias(this,tanamanList);
//        System.out.println(tanamanAdapter);
